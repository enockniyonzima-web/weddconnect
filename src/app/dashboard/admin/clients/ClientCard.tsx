...
const ClientCard = ({client}:{client: TAdminClientSelect}) => {
     return (
          <div className="w-full flex  items-center justify-center bg-white rounded-[10px] p-[10px] gap-[10px]">
               <div className="w-auto flex items-center justify-start gap-[10px] overflow-x-hidden">
               ...
               <div className="h-full border-l-[1.2px] border-gray-400 "></div>
               <div className="w-auto flex flex-col items-start gap-[5px] ">
