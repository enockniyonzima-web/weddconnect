...
export const HeroSection = () => {
     ...
     return (
          <div className="w-full flex flex-col items-center justify-start gap-4 p-2 lg:p-4">
               <h1 className="text-2xl text-white font-bold w-full text-start">Platform Users</h1>
               <div className="w-full flex items-end justify-between flex-wrap gap-2">
                    ...
                    <div className="w-auto gap-[10px] flex items-center ">
                         ...
                         <AdminForm icon={<i className="text-[18px]"><FaPlus /></i>} name="Add a User" className="bg-blue-600 text-base rounded-lg whitespace-nowrap hover:bg-blue-500 py-2 px-4 text-white flex items-center gap-2 transition-colors" />
                    </div>
               </div>
          </div>
     )
