     ...
     return (
          <section className="w-full aspect-[100/140] relative md:aspect-[100/50] lg:aspect-[100/40] bg-black">
               ...
               <div className="w-full h-full bg-black/50 flex flex-col items-center justify-center gap-[20px] px-[2%] relative z-10">
                    ...
                    <Link className=" flex items-center gap-[5px] text-[0.9rem] px-[20px] rounded-[5px] py-[10px] bg-blue-500 text-white hover:bg-blue-600 transition-all duration-300" href="/auth/sign-up">Get Started <i className="text-[18px]"><FaArrowRight /></i> </Link>
               </div>
          </section>
     );
}
