     ...
     return (
          <div className="w-full">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    {/* Total Clients */}
                    <div className="bg-gray-900 rounded-xl border border-gray-800 p-6 hover:border-gray-700 transition-all duration-300">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="bg-gradient-to-br from-amber-950/30 to-amber-900/20 rounded-xl p-6 border border-amber-800">
                         <div className="flex items-center gap-3 mb-2">
                              <Calendar className="w-5 h-5 text-amber-400" />
                              <h4 className="font-semibold text-amber-300">Pending</h4>
                         </div>
                         <p className="text-2xl font-bold text-amber-200">
                              {stats.clientsWithPendingSubscriptions}
                         </p>
                         <p className="text-sm text-amber-400 mt-1">Awaiting approval</p>
                    </div>

                    {/* Expired Subscriptions */}
                    <div className="bg-gradient-to-br from-red-950/30 to-red-900/20 rounded-xl p-6 border border-red-800">
                         <div className="flex items-center gap-3 mb-2">
                              <UserX className="w-5 h-5 text-red-400" />
                              <h4 className="font-semibold text-red-300">Expired</h4>
                         </div>
                         <p className="text-2xl font-bold text-red-200">
                              {stats.clientsWithExpiredSubscriptions}
                         </p>
                         <p className="text-sm text-red-400 mt-1">Need renewal</p>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-6 border border-gray-700">
                         <div className="flex items-center gap-3 mb-2">
                              ...
                              <h4 className="font-semibold text-gray-200">No Subscription</h4>
                         </div>
                         <p className="text-2xl font-bold text-white">
                              {stats.clientsWithoutSubscriptions}
                         </p>
                         <p className="text-sm text-gray-400 mt-1">Free tier</p>
                    </div>

                    {/* Recent Activity */}
                    <div className="bg-gradient-to-br from-blue-950/30 to-blue-900/20 rounded-xl p-6 border border-blue-800">
                         <div className="flex items-center gap-3 mb-2">
                              <Activity className="w-5 h-5 text-blue-400" />
                              <h4 className="font-semibold text-blue-300">Last 7 Days</h4>
                         </div>
                         <p className="text-2xl font-bold text-blue-200">
                              {stats.recentSignups}
                         </p>
                         <p className="text-sm text-blue-400 mt-1">New signups</p>
                    </div>
               </div>
          </div>
     );
