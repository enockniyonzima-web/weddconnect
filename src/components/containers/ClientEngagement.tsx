          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 p-6">
               <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                         ...
                         <p className="text-sm text-gray-400">Client activity metrics</p>
                    </div>
               </div>

               <div className="space-y-6">
                    {/* Engagement Rate */}
                    <div className="bg-gradient-to-br from-purple-950/30 to-pink-950/30 rounded-lg p-5 border border-purple-800">
                         ...
                         <div className="grid grid-cols-2 gap-3 mt-4">
                              <div className="bg-gray-800 rounded-lg p-3 text-center">
                                   ...
                                   <p className="text-lg font-bold text-white">{stats.clientsWithReviews}</p>
                                   <p className="text-xs text-gray-400">With Reviews</p>
                              </div>
                              <div className="bg-gray-800 rounded-lg p-3 text-center">
                                   <Heart className="w-4 h-4 mx-auto mb-1 text-red-400" />
                                   <p className="text-lg font-bold text-white">{stats.clientsWithLikes}</p>
                                   <p className="text-xs text-gray-400">With Likes</p>
                              </div>
                         </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                         ...
                         <div className={`rounded-lg p-5 border-2 ${
                              retentionIsGood 
                                   ...
                                   : 'bg-gradient-to-br from-amber-950/30 to-orange-950/30 border-amber-800'
                         }`}>
                              <div className="flex items-center gap-2 mb-3">
                                   ...
                                   <h4 className="font-semibold text-white">Renewal Rate</h4>
                              </div>
                         ...
                         <div className={`rounded-lg p-5 border-2 ${
                              churnIsLow 
                                   ? 'bg-gradient-to-br from-blue-950/30 to-cyan-950/30 border-blue-800' 
                                   : 'bg-gradient-to-br from-red-950/30 to-pink-950/30 border-red-800'
                         }`}>
                              <div className="flex items-center gap-2 mb-3">
                                   {churnIsLow ? (
                                   ...
                                   <h4 className="font-semibold text-white">Churn Rate</h4>
                              </div>
                              <p className={`text-3xl font-bold mb-2 ${
